...
>(
  (
    ...
    const { isMobile, state, openMobile, setOpenMobile, isTransitioning } = useSidebar()
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-300 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-out will-change-[width] md:flex",
            side === "left"
